...
export const DatasetEdgeRef =
  builder.objectRef<Record<string, unknown>>("DatasetEdge")
export const DatasetConnectionRef =
  builder.objectRef<Record<string, unknown>>("DatasetConnection")
export const DraftRef = builder.objectRef<Record<string, unknown>>("Draft")
export const SnapshotRef =
  builder.objectRef<Record<string, unknown>>("Snapshot")
export const CommentRef = builder.objectRef<Record<string, unknown>>("Comment")
export const DatasetEventRef =
  builder.objectRef<Record<string, unknown>>("DatasetEvent")
export const DatasetEventDescriptionRef =
  builder.objectRef<Record<string, unknown>>("DatasetEventDescription")
export const PermissionRef =
  builder.objectRef<Record<string, unknown>>("Permission")
